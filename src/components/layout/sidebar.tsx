...
const navItems: NavItem[] = [
  ...
  {
    label: "Persona Filling",
    href: "/persona-filling",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const Sidebar = () => {
  ...
  return (
    <aside
      className={`fixed left-0 top-0 h-full bg-card border-r transition-all duration-300 z-40 ${isCollapsed ? "w-16" : "w-64"
        }`}
    >
